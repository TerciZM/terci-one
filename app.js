...
function previewCustomerCopy() {
  ...
  @page{size:A4;margin:16mm}body{font:13px Arial,sans-serif;color:#3c4144;margin:0;padding:30px;background:#fff} .page{max-width:860px;margin:auto}.header{display:flex;justify-content:space-between;align-items:flex-start;min-height:180px}.logo{width:230px;height:145px;border-bottom:3px solid #ed1b2f;color:#17343b;display:flex;flex-direction:column;justify-content:center}.logo-mark{font-size:46px;font-weight:900;letter-spacing:5px;color:#17343b}.logo-sub{color:#ed1b2f;font-weight:800;letter-spacing:3px}.company{text-align:right;line-height:1.45}.company strong{font-size:16px}.title{display:flex;align-items:center;gap:20px;margin:8px 0 28px;color:#444}.title:before,.title:after{content:"";height:1px;background:#ddd;flex:1}.title b{font-size:23px;font-weight:400}.meta{display:grid;grid-template-columns:1fr 1fr;gap:35px;margin-bottom:26px}.bill{line-height:1.55}.bill strong{font-size:15px}.meta table{width:100%;border-collapse:collapse}.meta td{padding:9px;border:1px solid #ddd}.meta td:first-child{background:#f0f0f0;width:48%}.subject{margin:22px 0 38px}.items{width:100%;border-collapse:collapse}.items th{background:#efefef;font-weight:400}.items th,.items td{padding:10px;border:1px solid #ddd}.items th:first-child,.items td:first-child{width:42px;text-align:center}.items th:nth-child(2),.items td:nth-child(2){text-align:left}.items th:not(:nth-child(2)),.items td:not(:nth-child(2)){text-align:right}.items small{display:block;color:#999;margin-top:5px}.bottom{display:grid;grid-template-columns:1fr 1fr;gap:40px;margin-top:28px}.bank{line-height:1.45}.totals{justify-self:end;width:100%}.totals div{display:flex;justify-content:space-between;padding:9px 0;border-bottom:1px solid #ddd}.totals .grand{font-size:17px;font-weight:bold}.terms{margin-top:35px;line-height:1.5}.footer{border-top:1px solid #ddd;margin-top:40px;padding-top:12px;color:#667080;font-size:11px}</style></head><body><div class="page"><header class="header"><div class="logo"><div class="logo-mark">TERCI</div><div class="logo-sub">COMMUNICATIONS LIMITED</div></div><div class="company"><strong>Terci Communications Limited (Z)</strong><br>Kitwe Copperbelt 10101<br>Zambia<br>+260 972 888 575<br>info@terci.net</div></header><div class="title"><b>QUOTE</b></div><section class="meta"><div class="bill">Bill To<br><strong>${customer}</strong><br>Kitwe<br>Copperbelt<br>Zambia</div><table><tr><td>Quote#</td><td>${number}</td></tr><tr><td>Quote Date</td><td>${date}</td></tr><tr><td>Expiry Date</td><td>${date}</td></tr></table></section><div class="subject"><b>Subject:</b><br><br>Quotation for Terci Communications services</div><table class="items"><thead><tr><th>#</th><th>Item &amp; Description</th><th>Qty</th><th>Rate</th><th>Amount</th></tr></thead><tbody>${rows.map((r, i) => `<tr><td>${i + 1}</td><td>${r.name || r.description || "Item"}<small>${r.description || ""}</small></td><td>${Number(r.quantity || 1).toFixed(2)}<small>${r.unit_of_measure || "Each"}</small></td><td>${money(r.selling_price)}</td><td>${money((r.quantity || 1) * Number(r.selling_price || 0))}</td></tr>`).join("")}</tbody></table><section class="bottom"><div class="bank"><b>Payment Details</b><br>Terci Communications Limited<br>Payment details will be provided on request.</div><div class="totals"><div><span>Sub Total</span><span>${money(total)}</span></div><div class="grand"><span>Total</span><span>ZMW${Number(total || 0).toLocaleString("en-ZM", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span></div></div></section><section class="terms"><h3>Terms &amp; Conditions</h3>Prices are quoted in Zambian Kwacha (ZMW).<br>Validity: ${validity} from date of quotation.<br>Delivery and installation timelines will be communicated upon confirmation.</section><div class="footer">Terci Communications Limited · Integrated Security &amp; Connectivity Solutions</div></div></body></html>`);
